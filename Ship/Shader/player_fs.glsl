...
void main()
{
	...
	// colorResult = LE_CalculateLightList(texColor.xyz); 
	//vec3 colorResult = LE_CalculateLightList(vec3(0.0)); 
	...
	//vec4 d = mix(vec4(0.4), vec4(colorResult, 1.0), length(colorResult)); 
	//LE_FragColor = d; 
